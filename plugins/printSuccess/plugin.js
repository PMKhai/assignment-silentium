...
module.exports = {
	async apply(value, previousValues) {
		return new Promise(resolve => {
			console.log('\n');
			console.log(
				'TheCodingMachine React-Native Silenium initialized with success ! 🚀\n'
			);
			console.log(
				`${green(
					'                                                                    .-`    `::  \n' +
			...
			console.log(
				'- 📚 If you need to read more about this silenium : https://thecodingmachine.github.io/react-native-silenium/'
			);
			console.log(
				'- 🤕 If you have some troubles : https://github.com/thecodingmachine/react-native-silenium/issues'
			);
			console.log(
				'- ⭐ If you love this silenium, give us a star, you will be a ray of sunshine in our lives :) https://github.com/thecodingmachine/react-native-silenium'
			);
